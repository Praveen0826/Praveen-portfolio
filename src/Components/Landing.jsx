...
const Hero = () => {
  return (
    <section className="min-h-screen bg-[#0d1117] text-white flex flex-col-reverse md:flex-row items-center md:justify-between gap-12 px-6 md:px-20 pt-10 md:pt-0  md:gap-32 overflow-hidden">
