...
const Hero = () => {
  return (
    <section id="home" className="md:h-[100vh] md:mt-2 mt-30 bg-[#0d1117] text-white flex flex-col-reverse md:flex-row items-center md:justify-between gap-12 px-6 md:px-20  md:pt-0  md:gap-32 overflow-hidden">
